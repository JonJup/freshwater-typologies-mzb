...
These regulatory frameworks, such as the Water Framework Directive (WFD), typically reduce the inherent complexity of freshwater ecosystems through classification systems that use selected features to derive a typology. 
...
In addition, we compared the performance to delineate assemblages to three other freshwater typologies.
...
Finaly, we also compared two fundamentally different approaches to classifying rivers: reach-based and region-based typologies.   
<!-- RESOLUTION --> 
