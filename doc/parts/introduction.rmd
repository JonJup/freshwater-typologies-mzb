...
The main stressors to which this situation can be attributed are well
known and can be summarized as overexploitation, water pollution, flow
modification, habitat degradation and species invasions [@Dudgeon2006;
@Vorosmarty2010]. Addressing these problems is complicated by the
emergence of new stressors such as microplastics and light pollution
[@Reid2018] and interactions between co-occurring stressors
[@Schinegger2012; @Birk2020; @Comte2021].
...
process has been initiated. <!-- ### LS Typology      --> A recent
output of the intercalibration process is a pan-European typology of
lentic and lotic freshwater systems [@LycheSolheim2019]. While the WFD
...
However, many national river types (42%) are not associated with any of the intercalibration types while others are linked to multiple types [@ec19]. 
-->
```
The recent effort by @LycheSolheim2019 combined the national typologies
and connected the new, broad river types (BRT) with the established
