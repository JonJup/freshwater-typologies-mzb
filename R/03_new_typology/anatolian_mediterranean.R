...
data.med <-
        data |>
        filter(short_name == "anatolian" & m_btype12 %in% c("RT11", "RT12"))
...
# saveRDS(geo.med, "R/new_typology/auxilliary/anatolian_geo_med.RDS")
geo.med <- readRDS("R/new_typology/auxilliary/anatolian_geo_med.RDS")
...
data.med |> pull(dominant_geology) |> unique()
setDT(data.med)
data.med[dominant_geology %in% c("unknown", "missing", "mixed"), dominant_geology := "calcareous"]
...
data[dominant_geology == "calcareous" & m_btype20c == "RT17" & short_name == "anatolian" , brt_bgr := "RT02_anatolian"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT17" & short_name == "anatolian" , brt_bgr := "RT04_anatolian"]
data[dominant_geology == "calcareous" & m_btype20c == "RT18" & short_name == "anatolian" , brt_bgr := "RT06_anatolian"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT18" & short_name == "anatolian" , brt_bgr := "RT08_anatolian"]
data[dominant_geology == "calcareous" & m_btype20c == "RT19" & short_name == "anatolian" , brt_bgr := "RT07_anatolian"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT19" & short_name == "anatolian" , brt_bgr := "RT09_anatolian"]
data[dominant_geology == "calcareous" & m_btype20c == "RT20" & short_name == "anatolian" , brt_bgr := "RT07_anatolian"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT20" & short_name == "anatolian" , brt_bgr := "RT09_anatolian"]
...
data |> 
        filter(short_name == "anatolian") |> 
        pull(brt_bgr) |> 
        unique()

saveRDS(data, "R/new_typology/auxilliary/data_after_anatolian.RDS")
