### --- BRT X BGR - ATLANTIC - HIGHLANDS --- ### 

#- extract atlantic highland data 
data.med <-
        data |>
        filter(short_name == "atlantic" & m_btype20c == "RT16")
...
# saveRDS(geo.med, "R/new_typology/auxilliary/atlantic_geo_med2.RDS")
geo.med <- readRDS("R/new_typology/auxilliary/atlantic_geo_med2.RDS")
...
data[dominant_geology == "calcareous" & m_btype20c == "RT16" & short_name == "atlantic", brt_bgr := "RT06_atlantic"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT16" & short_name == "atlantic", brt_bgr := "RT08_atlantic"]
...
saveRDS(data, "R/new_typology/auxilliary/data_after_atlantic2.rds")
