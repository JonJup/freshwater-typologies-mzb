### --- BRT X BGR - Continental - HIGHLAND --- ### 

#- extract Continental highland data 
data.med <-
        data |>
        filter(short_name == "continental" & m_btype20c == "RT16")
...
#- 32 NAs 
#fec.med |> filter(is.na(dominant_geology))
...
setDT(fec.med)
fec.med[ZHYD %in% c("F030003259", "C030002378", "F030002920"), dominant_geology := "calcareous"]
fec.med[ZHYD %in% c("C030002383", "C030002168", "C030002191", "C030002018", "C030001804", "C020007166"), dominant_geology := "siliceous"]
fec.med <- st_as_sf(fec.med)
...
data[dominant_geology == "calcareous" & m_btype20c == "RT16" & short_name == "continental", brt_bgr := "RT06_continental"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT16" & short_name == "continental", brt_bgr := "RT08_continental"]
...
saveRDS(data, "R/new_typology/auxilliary/data_after_continental2.rds")
