### --- BRT X BGR - BlackSea - MEDITERRANEAN --- ### 

#- extract BlackSea Mediterranean data 
data.med <-
        data |>
        filter(short_name == "blackSea" & m_btype12 %in% c("RT11", "RT12"))
...
data[dominant_geology == "calcareous" & m_btype20c == "RT17" & short_name == "blackSea" , brt_bgr := "RT02_blackSea"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT17" & short_name == "blackSea" , brt_bgr := "RT04_blackSea"]
data[dominant_geology == "calcareous" & m_btype20c == "RT18" & short_name == "blackSea" , brt_bgr := "RT06_blackSea"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT18" & short_name == "blackSea" , brt_bgr := "RT08_blackSea"]
data[dominant_geology == "calcareous" & m_btype20c == "RT19" & short_name == "blackSea" , brt_bgr := "RT07_blackSea"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT19" & short_name == "blackSea" , brt_bgr := "RT09_blackSea"]
data[dominant_geology == "calcareous" & m_btype20c == "RT20" & short_name == "blackSea" , brt_bgr := "RT07_blackSea"]
data[dominant_geology == "siliceous"  & m_btype20c == "RT20" & short_name == "blackSea" , brt_bgr := "RT09_blackSea"]
data[, dominant_geology := NULL]
data <- st_as_sf(data)

data |> 
        filter(short_name == "blackSea") |> 
        pull(brt_bgr) |> 
        unique()


saveRDS(data, "R/new_typology/auxilliary/data_after_blackSea.RDS")
