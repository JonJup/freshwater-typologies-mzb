### --- BRT X IFE - Baltic - MEDITERRANEAN --- ### 
...
geo.med %<>% mutate( geology = ifelse (is.na(geology), acid_basic, geology))
...
saveRDS(data, paste0("R/new_typology/brtxife/data/02_data_",type,".rds"))
