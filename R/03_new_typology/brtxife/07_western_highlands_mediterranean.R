### --- BRT X IFE - Western Highlands - Mediterranean --- ### 

#- extract alpine Mediterranean data 
data.med <- data[NAME == type & m_btype12 %in% c("RT11", "RT12")]
...
#mapview(fec.med, zcol = "dominant_geology")
fec.med%<>%mutate(dominant_geology=ifelse(dominant_geology=="mixed","siliceous",dominant_geology))
