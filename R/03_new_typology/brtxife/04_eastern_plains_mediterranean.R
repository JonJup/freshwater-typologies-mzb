### --- BRT X IFE - Eastern Plains - Mediterranean --- ### 
...
fec.med %<>% mutate(dominant_geology = ifelse(dominant_geology == "missing", "calcareous", dominant_geology))
...
saveRDS(data, paste0("R/new_typology/brtxife/data/04_data_",type,".rds"))
