...
#  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#  date created: 29-10-22
# last modified: 29-10-22
...
sink(file = paste0("R/STOTEN-reivew/006","_", Sys.Date(), "_", "log.txt"))
Sys.Date()
x$path
sessionInfo()
sink(file = NULL)
...
saveRDS(results, paste0("data/review/04_",Sys.Date(),"_results_anosim_review.rds"))
