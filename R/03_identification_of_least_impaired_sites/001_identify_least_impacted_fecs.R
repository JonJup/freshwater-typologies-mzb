...
sink(file = paste0("R/03_identification_of_least_impaired_sites/001","_", Sys.Date(), "_", "log.txt"))
Sys.Date()
x$path
sessionInfo()
sink(file = NULL)
rm(x)
# load data -------------------------------------------------------------------------
data  <- st_read("E://Arbeit/Data/Lemm_et_al_21/MultipleStress_RiverEcoStatus.shp")
