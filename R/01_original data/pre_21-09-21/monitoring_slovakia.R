...
# Purpose:
#       In this script I create a harmonized spatial data set from the monitoring data 
#       from Slovakia. See Straka et al (2021) Ecol. Ind. for more details. 
#  ——————————————————————————————————————————  #
...
data       <- read_excel("data/original data/monitoring_slovakia/raw_data/Data source CZ for Jonathan_River Typology_corrected2.xlsx", sheet = 1) 
...
saveRDS(data2, paste0("data/original data/monitoring_slovakia/auxilliary/01_",Sys.Date(),"_data2.rds"))
data2      <- readRDS("data/original data/monitoring_slovakia/auxilliary/01_2021-08-25_data2.rds")
...
#- save to or load from file 
saveRDS(data4, paste0("data/original data/monitoring_slovakia/auxilliary/02_",Sys.Date(),"_data4.rds"))
data4 <- readRDS("data/original data/monitoring_slovakia/auxilliary/02_2021-08-25_data4.rds")
...
#- save sites to file 
saveRDS (sites, paste0("data/original data/monitoring_slovakia/auxilliary/03_",Sys.Date(),"_sites.rds"))
sites <- readRDS("data/original data/monitoring_slovakia/auxilliary/03_2021-08-25_sites.rds")
...
beepr::beep()
#- save to or load from file
saveRDS(distance_list, paste0("data/original data/monitoring_slovakia/auxilliary/04_",Sys.Date(),"_distance_to_brt.rds"))
distance_list  <- readRDS("data/original data/monitoring_slovakia/auxilliary/04_2021-08-24_distance_to_brt.rds")
...
#- save to or load from file 
saveRDS(sites6, paste0("data/original data/monitoring_slovakia/auxilliary/06_", Sys.Date(), "_sites2.rds"))
saveRDS(data5,  paste0("data/original data/monitoring_slovakia/auxilliary/07_", Sys.Date(), "_data5.rds"))

sites2 <- readRDS("data/original data/aqem_romania/auxilliary/06_2021-08-04_sites2.rds")
data5 <- readRDS("data/original data/aqem_romania/auxilliary/07_2021-08-04_data5.rds")
...
# SAVE TO FILE ----------------------------------------------------------------------
saveRDS(data6, paste0("data/original data/monitoring_slovakia/",Sys.Date(),"_final_aggregated.rds"))       
saveRDS(data5, paste0("data/original data/monitoring_slovakia/",Sys.Date(),"_final.rds"))    
