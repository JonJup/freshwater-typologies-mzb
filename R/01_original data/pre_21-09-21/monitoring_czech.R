...
# Purpose:
#       In this script I create a harmonized spatial data set from the Czechia monitoring data provided by Michal Straka and Marek Polášek  
# --------------------------------------------------------------------------------------------------------
...
data  <- read_excel("data/original data/monitoring_czech/raw/PA_State_monitoring_data_for_Jonathan.xlsx") 
...
data2 <- data.table(
        original_site_name = data$PROFIL_ID,
        date               = ymd(data$DATUM),
        taxon              = data$TAXON,
...
saveRDS(data4, paste0("data/original data/monitoring_czech/auxilliary/02_",Sys.Date(),"_data4.rds"))
data4 <- readRDS("data/original data/monitoring_czech/auxilliary/02_2021-09-03_data4.rds")
...
#- save sites to file 
saveRDS (sites, paste0("data/original data/monitoring_czech/auxilliary/03_",Sys.Date(),"_sites.rds"))
sites <- readRDS("data/original data/monitoring_czech/auxilliary/03_2021-08-18_sites.rds")
...
beepr::beep()
# #- save to or load from file
saveRDS(distance_list, paste0("data/original data/monitoring_czech/auxilliary/04_",Sys.Date(),"_distance_to_brt.rds"))
#distance_list  <- readRDS("data/original data/monitoring_czech/auxilliary/04_2021-08-18_distance_to_brt.rds")
...
#- save to or load from file 
saveRDS(sites6, paste0("data/original data/monitoring_czech/auxilliary/06_", Sys.Date(), "_sites2.rds"))
saveRDS(data5,  paste0("data/original data/monitoring_czech/auxilliary/07_", Sys.Date(), "_data5.rds"))

sites6 <- readRDS("data/original data/monitoring_czech/auxilliary/06_2021-08-18_sites2.rds")
data5 <- readRDS("data/original data/monitoring_czech/auxilliary/07_2021-08-18_data5.rds")
...
# SAVE TO FILE ----------------------------------------------------------------------
saveRDS(data6, paste0("data/original data/monitoring_czech/",Sys.Date(),"_final_aggregated.rds")) 
saveRDS(data5.save, paste0("data/original data/monitoring_czech/",Sys.Date(),"_final.rds")) 
