...
# Purpose:
#       In this script I create a harmonized spatial data set from the Belgium monitoring data 
# --------------------------------------------------------------------------------------------------------
...
taxa  <- fread("data/original data/monitoring_belgium/raw/occurrence.txt") 
sites <- fread("data/original data/monitoring_belgium/raw/event.txt") 
