...
#       provided from Koutajoki by Kaisa-Leena Huttunen. 
# ———————————————————————————————————
...
samples    <- read_excel("data/original data/kaisa-leena_huttunen/raw_data/MI_data_KLHuttunen.xlsx") 
sites      <- read_excel("data/original data/kaisa-leena_huttunen/raw_data/MI_data_KLHuttunen.xlsx", sheet = 2) 
...
saveRDS(data2, paste0("data/original data/kaisa-leena_huttunen/auxilliary/01_",Sys.Date(),"_data2.rds"))
data2 <- readRDS("data/original data/kaisa-leena_huttunen/auxilliary/01_2021-07-20_data2.rds")
...
#- save to or load from file 
saveRDS(data4, paste0("data/original data/kaisa-leena_huttunen/auxilliary/02_",Sys.Date(),"_data4.rds"))
data4 <-      readRDS("data/original data/kaisa-leena_huttunen/auxilliary/02_2021-08-26_data4.rds")
...
#- save sites to file 
saveRDS (sites, paste0("data/original data/kaisa-leena_huttunen/auxilliary/03_", Sys.Date(),"_sites.rds"))
sites <-       readRDS("data/original data/kaisa-leena_huttunen/auxilliary/03_2021-08-26_sites.rds")
...
beepr::beep()
#- save to or load from file 
saveRDS(distance_list, paste0("data/original data/kaisa-leena_huttunen/auxilliary/04_",Sys.Date(),"_distance_to_brt.rds"))
distance_list  <- readRDS("data/original data/kaisa-leena_huttunen/auxilliary/04_2021-08-26_distance_to_brt.rds")
...
#- save to or load from file 
saveRDS(sites6, paste0("data/original data/kaisa-leena_huttunen/auxilliary/06_", Sys.Date(), "_sites2.rds"))
saveRDS(data5,  paste0("data/original data/kaisa-leena_huttunen/auxilliary/07_", Sys.Date(), "_data5.rds"))

sites <- readRDS("data/original data/kaisa-leena_huttunen/auxilliary/06_2021-08-26_sites2.rds")
data5 <- readRDS("data/original data/kaisa-leena_huttunen/auxilliary/07_2021-08-26_data5.rds")
...
for (i in 1:nrow(sites)) {
        ...
        if(round(lp.progress,1) %% 5 <= 0.1) print(lp.progress)
...
data6[, c("sampling.events") := NULL]

#- save to or load from file 
saveRDS(data6, paste0("data/original data/kaisa-leena_huttunen/auxilliary/08_",Sys.Date() , "_data6.rds"))
data6 <-      readRDS("data/original data/kaisa-leena_huttunen/auxilliary/08_2021-08-26_data6.rds")
...
# SAVE TO FILE  ---------------------------------------------------------------------
saveRDS(data5, paste0("data/original data/kaisa-leena_huttunen/",Sys.Date(),"_final.rds"))
saveRDS(data6, paste0("data/original data/kaisa-leena_huttunen/",Sys.Date(),"_final_aggregated.rds"))
data6 <- readRDS("data/original data/kaisa-leena_huttunen/2021-08-02_final.rds")
