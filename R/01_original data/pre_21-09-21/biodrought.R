...
# Purpose:
#       In this script I create a harmonized spatial data set from the BIODROUGHT data from the Czech Republic provided by Petr Paril
# ----------------------------
...
data       <- read_excel("data/original data/biodrought/raw_data/Data source CZ for Jonathan_River Typology_corrected2.xlsx", sheet = 3) 
coords     <- read_excel("data/original data/biodrought/raw_data/Data source CZ for Jonathan_River Typology_corrected2.xlsx", sheet = 2)
...
saveRDS(data2, paste0("data/original data/biodrought/auxilliary/01_",Sys.Date(),"_data2.rds"))
data2      <- readRDS("data/original data/biodrought/auxilliary/01_2021-08-24_data2.rds")
...
#- save to or load from file 
saveRDS(data4, paste0("data/original data/biodrought/auxilliary/02_",Sys.Date(),"_data4.rds"))
data4 <- readRDS("data/original data/biodrought/auxilliary/02_2021-08-24_data4.rds")
...
#- save sites to file 
saveRDS (sites, paste0("data/original data/biodrought/auxilliary/03_",Sys.Date(),"_sites.rds"))
sites <- readRDS("data/original data/biodrought/auxilliary/03_2021-08-02_sites.rds")
...
beepr::beep()
# #- save to or load from file
saveRDS(distance_list, paste0("data/original data/biodrought/auxilliary/04_",Sys.Date(),"_distance_to_brt.rds"))
distance_list  <- readRDS("data/original data/biodrought/auxilliary/04_2021-08-02_distance_to_brt.rds")
...
#- save to or load from file 
saveRDS(sites6, paste0("data/original data/biodrought/auxilliary/06_", Sys.Date(), "_sites2.rds"))
saveRDS(data5,  paste0("data/original data/biodrought/auxilliary/07_", Sys.Date(), "_data5.rds"))

sites2 <- readRDS("data/original data/biodrought/auxilliary/06_2021-08-04_sites2.rds")
data5 <- readRDS("data/original data/biodrought/auxilliary/07_2021-08-25_data5.rds")
