...
#- number of taxa 
dt_mzb$brt12[ final_taxon_level == "species", uniqueN(species)] + dt_mzb$brt12[ final_taxon_level == "genus", uniqueN(genus)]
dt_mzb$brt20[ final_taxon_level == "species", uniqueN(species)] + dt_mzb$brt20[ final_taxon_level == "genus", uniqueN(genus)]
dt_mzb$gloric[final_taxon_level == "species", uniqueN(species)] + dt_mzb$gloric[final_taxon_level == "genus", uniqueN(genus)]
dt_mzb$bgr[   final_taxon_level == "species", uniqueN(species)] + dt_mzb$bgr[   final_taxon_level == "genus", uniqueN(genus)]
dt_mzb$illies[final_taxon_level == "species", uniqueN(species)] + dt_mzb$illies[final_taxon_level == "genus", uniqueN(genus)]
