...
# data IO  ----------------------------------------------------------------
set_all = readRDS("data/summer season/04_invertebrates_w_typologies_summer.rds")
ls_res  = readRDS("data/summer season/05_taxon_resolution_list_all_typologies.rds")
...
# save to file ------------------------------------------------------------
saveRDS(file = "data/summer season/06_final_taxon_all_typologies.rds", dt_list)
