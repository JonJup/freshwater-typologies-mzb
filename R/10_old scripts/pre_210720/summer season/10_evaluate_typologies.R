...
# files out:  
#               <- summer season/auxilliary/10_cluster.eval.obj.rds
#               <- summer season/auxilliary/10_cluster.eval.obj_random.rds
#               <- summer season/auxilliary/10_gensil_output.rds
#               <- summer season/auxilliary/10_gensil_output_random.rds
#               <- summer season/10_class_eval_summer season.rds
# Purpose: 
...
# load data  ----------------------------------------------------------------------------------------------------------------------------------------------
data <- readRDS("data/summer season/09_sxs_genus_typology_with_bio.rds")
similaitry.matrix <- readRDS("data/summer season/auxilliary/09_biocluster_similarity_matrix.rds")


# analysis --------------------------------------------------------------------------
#- non taxa columns (ntc)
ntc <- which(names(data) %in% c("gr_sample_id", "brt20", "brt12", "illies", "bgr", "gloric", "bio9"))
...
saveRDS(cluster.eval.obj  , "data/summer season/auxilliary/10_cluster.eval.obj.rds")
cluster.eval.obj <- readRDS("data/summer season/auxilliary/10_cluster.eval.obj.rds")
...
saveRDS(cluster.eval.obj2  , "data/summer season/auxilliary/10_cluster.eval.obj_random.rds")
cluster.eval.obj2 <- readRDS("data/summer season/auxilliary/10_cluster.eval.obj_random.rds")
...
saveRDS(gensil_output, "data/summer season/auxilliary/10_gensil_output.rds")
gensil_output <- readRDS("data/summer season/auxilliary/10_gensil_output.rds")
...
saveRDS(gensil_output2,   "data/summer season/auxilliary/10_gensil_output_random.rds")
gensil_output2 <- readRDS("data/summer season/auxilliary/10_gensil_output_random.rds")
...
# save to file  ---------------------------------------------------------------------
saveRDS(final, "data/summer season/10_class_eval_summer.rds")
