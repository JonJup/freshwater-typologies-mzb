...
## -- load data 
dt_mzb  = readRDS("data/temporal_aggregation/06_final_taxon_all_typologies.rds")
...
saveRDS(dt_genus, "data/temporal_aggregation/06_final_taxon_genus_all_typologies.rds")
saveRDS(ls_mzb,   "data/temporal_aggregation/07_sxs_list_all_typologies.rds")
saveRDS(sxg,      "data/temporal_aggregation/07_sxs_genus_all_typologies.rds")
