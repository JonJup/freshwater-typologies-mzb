...
# data IO  ----------------------------------------------------------------
set_all = readRDS("data/temporal_aggregation/04_invertebrates_w_typologies_temporal_aggergated.rds")
ls_res  = readRDS("data/temporal_aggregation/05_taxon_resolution_list_all_typologies.rds")
...
# save to file ------------------------------------------------------------
saveRDS(file = "data/temporal_aggregation/06_final_taxon_all_typologies.rds", dt_list)
