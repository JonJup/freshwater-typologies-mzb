---
title: 'Individual Data Set: Monitoring Czech Republic'
...
da <-
        lapply(data, function(x)
                x[data.set == "Monitoring from the Czech Republic"])
...
c(nrow(da[[1]][is.na(species)])/nrow(da[[1]]), nrow(da[[2]][is.na(species)])/nrow(da[[2]]))
c(nrow(da[[1]][is.na(genus)])  /nrow(da[[1]]), nrow(da[[2]][is.na(genus)])  /nrow(da[[2]]))
c(nrow(da[[1]][is.na(family)]) /nrow(da[[1]]), nrow(da[[2]][is.na(family)]) /nrow(da[[2]]))

#- species missing in ~ 34% of observations 
#- genus missing in ~ 5% of observations 
#- family missing in no observation 
```
