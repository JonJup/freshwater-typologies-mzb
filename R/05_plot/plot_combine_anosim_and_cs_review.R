...
sink(file = paste0("R/05_plot/log_files/anosim_and_cs_review","_", Sys.Date(), "_", "log.txt"))
Sys.Date()
x$path
sessionInfo()
sink(file = NULL)
...
an.plot <- readRDS("fig/results_anosim/2022-05-04_anosim_plot_review.rds")
cs.plot <- readRDS("fig/results_classification_strength/2022-05-05_cs_plot_review.rds")
...
ggsave(plot = combined_plot, filename = "fig/anosim_cs_review.png", width = 7, height = 3)
