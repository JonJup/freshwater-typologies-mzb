...
ife  <- st_read("~/../Downloads/wfd_shp_ecoregions/Ecoregions.shp")
...
base_brt <-pivot_longer(base_brt, cols = !type, names_to = "season", values_to = "presence")
base_ife <-pivot_longer(base_ife, cols = !type, names_to = "season", values_to = "presence")
base_bgr <-pivot_longer(base_bgr, cols = !type, names_to = "season", values_to = "presence")
...
# save to file ----------------------------------------------------------------------
ggsave(filename = paste0("fig/si_types_per_season/",Sys.Date(), "types_bgr.png"), plot  = bgr_season_type_plot, dpi = 340, width = 4)
ggsave(filename = paste0("fig/si_types_per_season/",Sys.Date(), "types_ife.png"), plot  = ife_season_type_plot, dpi = 500, width = 4, height = 6)
